...
sed -i "s#10.37.15.71#192.168.2.100#" $extract_folder_name/install/setup/install_config.json
#sed -i "s#dc=domain#dc=domain#" $extract_folder_name/setup/install_config.json
sed -i "s#administrator@sourceone.com#administrator#" $extract_folder_name/install/setup/install_config.json
sed -i "s#emc#qampass1!#" $extract_folder_name/install/setup/install_config.json
...
sed -i "s#false#true#" $extract_folder_name/CIS/RestAPI/cis_constants.rb
