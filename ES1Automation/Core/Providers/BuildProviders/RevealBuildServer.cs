...
{
    class RevealBuildServer : IBuildProvider
    {
        private string localMapFolder = Core.LocalMappedFolder.RevealBuildFolder;

        private string productFolderName = "Reveal";

        private string ProductName = "Reveal 1.0";

        private string RevealBuildNamePattern = @"^[0-9]\.[0-9]\.[0-9]\.[0-9]{1,4}$";
        ...
        {
            foreach (Build buildOnBuildFileServer in GetAllBuildsOnRevealSBuildServer())
            {
        ...
        public IList<Build> GetAllBuildsOnRevealSBuildServer()
        {
            List<Build> builds = new List<Build>();

            System.Text.RegularExpressions.Regex reg = new System.Text.RegularExpressions.Regex(RevealBuildNamePattern);
